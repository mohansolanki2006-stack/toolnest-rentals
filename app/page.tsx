...
const categories: Category[] = [
  ...
  { name:"Gardening & Outdoor", slug:"gardening", image:"https://images.unsplash.com/photo-1599685315640-9ceab2f581ca?auto=format&fit=crop&w=1200&q=85", description:"Powerful lawn, tree-cutting, spraying and digging equipment.", subs:["Lawn Equipment","Tree Cutting","Hedge & Garden Cutting","Spraying Equipment","Soil & Digging Equipment"] },
...
const rentalMonths=[{name:"September 2026",days:30,offset:0,month:8},{name:"October 2026",days:31,offset:30,month:9},{name:"November 2026",days:30,offset:61,month:10}];
...
function pickupTimestamp(booking:Booking){
...
export default function Home() {
  ...
  const [startDay,setStartDay]=useState<number|null>(18);
  ...
  useEffect(()=>{const timer=window.setInterval(()=>setClock(Date.now()),30000);setClock(Date.now());return()=>window.clearInterval(timer)},[]);

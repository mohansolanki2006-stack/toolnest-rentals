...
export default function Home() {
  ...
  const bookingReady=clock>0&&validRentalSelection(startDay,endDay,pickup,clock);
  ...
  const confirmBooking=()=>{
    if(!validRentalSelection(startDay,endDay,pickup,Date.now())){
      setClock(Date.now());setCalendarError("Choose today or a future date, a valid return date, and a pickup time that has not passed.");return;
    }
